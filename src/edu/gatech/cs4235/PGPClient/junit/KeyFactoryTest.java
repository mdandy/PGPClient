package edu.gatech.cs4235.PGPClient.junit;
...
public class KeyFactoryTest extends TestCase
{
	...
	protected void setUp() throws Exception 
	{
		...
		passphrase = "georgiatech";
		
		message1 = "A computer would deserve to be called " + 
				   "intelligent if it could deceive a human " + 
				   "into believing that it was human.";
		message2 = "Science is a differential equation. " + 
